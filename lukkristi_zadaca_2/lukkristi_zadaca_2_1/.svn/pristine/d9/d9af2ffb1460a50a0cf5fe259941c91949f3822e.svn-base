...
public class KorisnikDAO {
    ...
    /**
     * Metoda koja iz baze dohvaca sve korisnike 
     * @param korIme
     * @param lozinka
     ...
     * @param lozinka
     * @param korIme
     * @return ako je uspjesno azuriran vraca true inace false 
     */
    ...
    /**
     * metoda koja provjera podatke koje je korisnik unjeo prije azuriranja 
     * @param k
     * @return true ako su svi podaci uneseni a false ako nisu 
     */
    ...
    /**
     * Metoda koja dodaje korisnika u bazu  
     * @param k
     * @param bpk
     * @return true ako je uspjesno dodao inace false
     */
    ...
    /**
     * Dohvaca sve korisnike koji imaju aerodrom koji prate iz baze 
     * @param korIme
     * @param lozinka
     * @return
     */
